...
--     min_header_size Anzahl Bytes, die nötig sind, um die Länge der PDU zu bestimmen
--     get_len_func Funktion, die aus einem Datenbuffer mit mindestens min_header_size Bytes die Lönge der PDU berechnet
--       bekommt als Argumente den Datenbuffer, das Paket und den Offset im Buffer, an dem die PDU Anfängt
--     dissect_func Eigentlicher Dissector für die PDU
--       bekommt dieselben Argumente wie die normale Dissectorfunktion: Datenbuffer, Paket und Datenmodell
